  ...
  return {
    ...
    definitions: document.definitions.map((definition) => {
      if (definition.kind === 'OperationDefinition') {
        return {
          ...definition,
          selectionSet: changeDocumentLanguageSelectionSet(
...
function changeDocumentLanguageSelectionSet(
  ...
  return {
    ...selectionSetNode,
    selections: selectionSetNode.selections.map((s) =>
      changeDocumentLanguageSelect(s, language, alias),
    ),
  }
}

function changeDocumentLanguageSelect(
