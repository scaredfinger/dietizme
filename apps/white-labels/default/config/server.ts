...
interface ServerEnvVariables {
  ...
  NEXT_BACKEND_HEALTHZ: string
}

const validationSchema = joi.object<ServerEnvVariables>({
  ...
  NEXT_BACKEND_HEALTHZ: joi.string().required(),
})

const processEnv: ServerEnvVariables = {
  ...
  NEXT_BACKEND_HEALTHZ: process.env.NEXT_BACKEND_HEALTHZ,
}
...
export const getServerEnv = () => {
  ...
  return value as ServerEnvVariables
}
