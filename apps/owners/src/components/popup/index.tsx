...
const defaultContent: any = (
  <>
    <Link
      className="text-start py-[6px] flex align-center gap-[6px] hover:text-primary "
      href="#"
    >
      <UilCheckCircle />
    ...
    <Link
      className="text-start py-[6px] flex align-center gap-[6px] hover:text-primary hover:bg-primary/.50"
      href="#"
    >
      <UilCheckCircle />
