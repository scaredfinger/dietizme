...
const chatReducer = (state = initialStateUpdate, action: any) => {
...
const SingleChatReducer = (state = initialState, action: any) => {
  const { type, data, err } = action
  switch (type) {
...
const groupChatReducer = (state = initialStateGroupChat, action: any) => {
  const { type, data, err } = action
  switch (type) {
...
const SingleChatGroupReducer = (state = initialStateGroup, action: any) => {
  const { type, data, err } = action
  switch (type) {
