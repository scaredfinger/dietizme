...
const events = [
  ...
  },
  {
    title: 'Team Meeting',
    id: 3,
    start: moment(moment().subtract(2, 'days').subtract(5, 'hours')).format(
      'MM/DD/YYYY/LT',
    ),
    end: moment(moment().subtract(2, 'days').add(2, 'hours')).format(
      'MM/DD/YYYY/LT',
    ),
    label: 'secondary',
    type: 'event',
  ...
  },
  {
    ...
    end: moment(moment().subtract(3, 'days').add(3, 'hours')).format(
      'MM/DD/YYYY/LT',
    ),
    label: 'info',
    type: 'event',
