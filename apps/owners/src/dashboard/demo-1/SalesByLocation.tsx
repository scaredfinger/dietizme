...
import { useWindowSize } from '@/components/utilities/windowWidth'
...
const SaleByLocation = React.memo(() => {
  ...
  if (
    salesLocation !== null &&
    salesLocation[locationTab as keyof SalesLocationData]
  ) {
    salesLocation[locationTab as keyof SalesLocationData].forEach(
          ...
          <Col xxl={12} md={11} xs={24} className="px-[25px]">
            <div className="min-ssm:h-full h-[250px] overflow-hidden">
              ...
              <ComposableMap
                ...
                projectionConfig={{
                  scale: windowSize.width <= 440 ? 160 : 160,
                }}
